...
my_symbols = lower_case + upper_case + numbers + punctuation
...
my_symbols = pd.DataFrame(my_symbols, columns=[Symbol])
```
...
top_secret = pd.read_csv('Secret_Code')['x']
...
```{python decrypt-the-message}
decrypted_str = ""

# Join the characters together with no separator
...
Write 3-4 sentences about what you learned from this investigation. What problems did you encounter, and how did you solve them? Could you do the same tasks in R? Why or why not?
